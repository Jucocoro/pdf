...
_recipes_pil_prescript(['ImImagePlugin', 'DcxImagePlugin', 'Jpeg2KImagePlugin', 'BufrStubImagePlugin', 'AvifImagePlugin', 'WebPImagePlugin', 'SpiderImagePlugin', 'GbrImagePlugin', 'McIdasImagePlugin', 'ImtImagePlugin', 'PalmImagePlugin', 'PdfImagePlugin', 'SunImagePlugin', 'IcnsImagePlugin', 'PngImagePlugin', 'IptcImagePlugin', 'Hdf5StubImagePlugin', 'TgaImagePlugin', 'TiffImagePlugin', 'PcxImagePlugin', 'MpoImagePlugin', 'GribStubImagePlugin', 'PsdImagePlugin', 'PpmImagePlugin', 'FpxImagePlugin', 'FitsImagePlugin', 'MspImagePlugin', 'IcoImagePlugin', 'JpegImagePlugin', 'WmfImagePlugin', 'QoiImagePlugin', 'DdsImagePlugin', 'EpsImagePlugin', 'FliImagePlugin', 'CurImagePlugin', 'GifImagePlugin', 'XbmImagePlugin', 'MpegImagePlugin', 'SgiImagePlugin', 'PcdImagePlugin', 'BmpImagePlugin', 'PixarImagePlugin', 'XVThumbImagePlugin', 'FtexImagePlugin', 'XpmImagePlugin', 'MicImagePlugin', 'BlpImagePlugin'])
...
DEFAULT_SCRIPT='extract_questions_tkinter.py'
SCRIPT_MAP={}
_run()
